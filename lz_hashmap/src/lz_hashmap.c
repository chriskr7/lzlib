...
/******************************************************************************/
/*  Version Note                                                              */
/*  0.2 - changing sem_init to sem_open due to Mac OS compability             */
/*        & forcing to semaphore exists in shared memory                      */
/******************************************************************************/
...
void lz_hashmap_init(_lz_hashmap* p_lzh)
{
    ...
    if((p_lzh->lock = sem_open("lz_hashmap_sem", O_CREAT, 0644, 1)) == SEM_FAILED)
		exit(EXIT_FAILURE);
#endif
}
